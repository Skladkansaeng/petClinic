...
urlpatterns = [
    ...
    path('createMedical',views_doctor.createMedical),
    path('createVaccine',views_doctor.createVaccine),
    path('doctor/doctorData/',views_doctor.sendJson),
    path('Makeappointment/',views_doctor.Makeappointment),
    path('getMedical/',views_doctor.getMedical),
    path('getVaccine/',views_doctor.getVaccine),
    path('staff/', staffViews.staff),
    path('user/',userViews.userpage),
    path('oak/', staffViews.createUser),
    path('getuserInfor/', staffViews.get_userInfo),
    ...
    path('doctor/<str:pk>', views_doctor.fonTest),
    path('staff/<str:pk>', staffViews.fonTest),
